				...
				<div class="pagination">
					<ul>
						...
						<c:if test="${purseGrid.current ne 1 }">
							<li><a href="admin/purseList?pageNum=${purseGrid.current-1 }">上一页</a>
							</li>
						</c:if>

						<c:if test="${purseGrid.current < (purseGrid.total+9)/10-1 }">
							<li><a
								href="admin/purseList?pageNum=${purseGrid.current+1 }">下一页</a>
							</li>
						</c:if>
					</ul>
				</div>
